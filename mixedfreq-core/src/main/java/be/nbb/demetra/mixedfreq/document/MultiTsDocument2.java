 ...
 * @param <R>
 */
public abstract class MultiTsDocument2<S extends IProcSpecification, R extends IProcResults> extends ActiveDocument<S, Ts[], R> {

    public static final String SERIES = "series";
    protected IProcessingFactory<S, TsData[], R> factory_;

    public MultiTsDocument2(IProcessingFactory<S, TsData[], R> factory) {
        super(factory.getInformation().name);
        this.factory_ = factory;
    }

    public MultiTsDocument2(IProcessingFactory<S, TsData[], R> factory, ProcessingContext context) {
...
//        }
    ...
    @Override
    public MultiTsDocument2<S, R> clone() {
        MultiTsDocument2<S, R> cl = (MultiTsDocument2<S, R>) super.clone();
