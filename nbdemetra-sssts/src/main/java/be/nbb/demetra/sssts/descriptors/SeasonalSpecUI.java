 ...
 * @author Jean Palate
 */
public class SeasonalSpecUI implements IPropertyDescriptors {

    final SeasonalSpecification core;

    public SeasonalSpecUI(SeasonalSpecification spec) {
        core = spec;
    }
...
//            core.noisyPeriods=values;
    ...
    public void setNoise(boolean noise){
        core.noisyComponent = noise ? Component.Noise : Component.Seasonal;
    }
