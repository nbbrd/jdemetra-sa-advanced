 ...
 * @author Jean Palate
 */
public class SSHSSpecUI implements IObjectDescriptor<SSHSSpecification> {

    final SSHSSpecification core;

    public SSHSSpecUI(SSHSSpecification spec) {
        core = spec;
    }
    ...
    public SeasonalSpecUI getMa() {
        return new SeasonalSpecUI(core.getDecompositionSpec());
    }
   ...
   private static final int PP_ID = 1, MA_ID = 2, BENCH_ID=3;
    ...
    @Override
    public SSHSSpecification getCore() {
        return core;
    }
}
