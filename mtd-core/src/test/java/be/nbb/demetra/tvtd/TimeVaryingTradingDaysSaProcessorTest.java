 ...
 * @author palatej
 */
public class TimeVaryingTradingDaysSaProcessorTest {
    
    public TimeVaryingTradingDaysSaProcessorTest() {
    }
...
//        RegArimaSpecification pspec = RegArimaSpecification.RG5.clone();
        TimeVaryingTradingDaysSpecification mspec = new TimeVaryingTradingDaysSpecification();
        X11Specification xspec = new X11Specification();
        xspec.setForecastHorizon(-3);
        xspec.setBackcastHorizon(-3);
        TimeVaryingTradingDaysSaResults rslt = TimeVaryingTradingDaysSaProcessor.process(data.Data.ABS09, pspec, mspec, xspec, null);
