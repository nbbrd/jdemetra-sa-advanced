 ...
 * @author Jean Palate
 */
public class MovingTradingDaysPreprocessingFilter implements IPreprocessingFilter {

    private final MovingTradingDaysEstimator mtde;
    private int nf = -2, nb = -2;

    public MovingTradingDaysPreprocessingFilter(MovingTradingDaysEstimator mtde) {
        this.mtde = mtde;
    }

    public PreprocessingModel getModel() {
        return mtde.getModel();
    }

    public MovingTradingDaysEstimator getMovingTradingDaysEstimator() {
        return mtde;
    }
    ...
    public TsData getCorrectedSeries(boolean transformed) {
        PreprocessingModel model = mtde.getModel();
        ...
        TsData mtd=mtde.tdEffect(domain);
    ...
    public TsData getCorrectedForecasts(boolean transformed) {
        ...
        TsData mtd=mtde.tdEffect(f.getDomain());
    ...
    public TsData getCorrectedBackcasts(boolean transformed) {
        ...
        TsData mtd=mtde.tdEffect(b.getDomain());
    ...
    public TsData getCorrection(TsDomain domain, ComponentType type, boolean transformed) {
        ...
        switch (type) {
            ...
            case Seasonal:
                ...
                TsData td = mtde.tdEffect(domain);
