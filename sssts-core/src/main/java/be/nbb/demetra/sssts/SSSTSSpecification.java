 ...
 * @author Jean Palate
 */
public class SSSTSSpecification implements ISaSpecification, Cloneable {
...
//
    @Override
    public SSSTSSpecification clone() {
        try {
            SSSTSSpecification spec = (SSSTSSpecification) super.clone();
    ...
    public boolean equals(Object obj) {
        return this == obj || (obj instanceof SSSTSSpecification && equals((SSSTSSpecification) obj));
    }

    private boolean equals(SSSTSSpecification other) {
