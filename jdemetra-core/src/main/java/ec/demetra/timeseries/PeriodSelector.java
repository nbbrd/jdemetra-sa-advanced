...
public class PeriodSelector implements Cloneable {
    ...
    private LocalDate d0_ = LocalDate.MIN, d1_ = LocalDate.MAX;
    private int n0_, n1_;
     ...
     */
    public void between(final LocalDate d0, final LocalDate d1) {
        doClear();
        if (d1.isBefore(d0)) {
     ...
     */
    public void from(final LocalDate d0) {
        doClear();
     ...
     * @return
     */
    public LocalDate getD0() {
        return d0_;
    }

    @Deprecated
    public void setD0(LocalDate d) {
        d0_ = d;
    }
     ...
     */
    public void to(final LocalDate d1) {
        doClear();
