 ...
 * @author Jean Palate
 */
public class StsSpecification implements ISaSpecification, Cloneable {
    ...
    public String toString() {
        return StsProcessingFactory.DESCRIPTOR.name;
    }

    @Override
    public StsSpecification clone() {
        try {
            StsSpecification spec = (StsSpecification) super.clone();
    ...
    public boolean equals(StsSpecification other) {
    ...
    public boolean equals(Object obj) {
        return this == obj || (obj instanceof StsSpecification && equals((StsSpecification) obj));
    }
